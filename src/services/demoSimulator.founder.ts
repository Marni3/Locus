...
/**
 * ARCHIVED PREVIOUS DEMO DATASET: "Founder Persona" (6 Entries across 30 Days)
 * Preserved for reference or regression testing.
 */
export function getFounderDemoDataset(userId: string = DEMO_USER_ID): {
  entries: Entry[];
  themes: Theme[];
  ...
  const entries: Entry[] = [
    {
      ...
      bodySealedAt: subDays(30),
      stratumCount: 2,
      returnCount: 1,
      openThreads: ['Should we ship the minimal core loop first or wait for mobile?'],
      status: 'concluded',
      category: 'Work',
      mood: 'Overwhelmed',
      mode: 'reflect',
      ...
      turns: [
        {
          ...
          isPinned: true,
          isBookmarked: true,
          note: 'Radical simplification restored clarity.',
        },
        {
          id: 'turn-2-2',
          entryId: 'demo-entry-2',
      ...
      turns: [
        {
          ...
          isPinned: true,
          isBookmarked: true,
          note: 'Contract-first interfaces liberate team creativity.',
        },
        {
          id: 'turn-4-2',
          entryId: 'demo-entry-4',
