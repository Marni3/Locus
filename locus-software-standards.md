...
> [!IMPORTANT]
> This is the primary standard for all development in Locus / ReflectAI.
> It is also formalized in the workspace agent configuration:
> - **Root Directive**: [AGENTS.md](file:///c:/Users/reyna/OneDrive/Documents/Locus/AGENTS.md)
> - **Workspace Rule**: [.agents/rules/software-standards.md](file:///c:/Users/reyna/OneDrive/Documents/Locus/.agents/rules/software-standards.md)
> - **Workspace Skill**: [.agents/skills/locus-software-standards/SKILL.md](file:///c:/Users/reyna/OneDrive/Documents/Locus/.agents/skills/locus-software-standards/SKILL.md)
...
* Produce steps to test that a user can walk through, broken down into specific pieces of functionality that another coding tool can turn into actual test scripts. Every type of process and user interaction that a user can see or trigger must have a corresponding test case written out.